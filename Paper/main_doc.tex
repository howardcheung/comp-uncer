...
\newcommand{\blCom}[1]{\begingroup\sffamily\color{blue} #1 \endgroup}  %blue comments on
%\newcommand{\blCom}[1]{}  %blue comments off
...
\input{unc_steady}
\input{Approx_uncertainty}
\input{sources_of_uncertainty}
\input{Results_Discussion_CB}

\input{comp_map_uncer}
